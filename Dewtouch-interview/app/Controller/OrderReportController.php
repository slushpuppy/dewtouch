<?php
	class OrderReportController extends AppController{
		...
		public function index(){
            ...
            $orderData = [];
            foreach($orders as $dbOrderRow)
            {
                $detail = [];
                foreach($dbOrderRow['OrderDetail'] as $dbOrderDetailRow)
                {
                    $detail[$dbOrderDetailRow["Item"]["name"]] = $dbOrderDetailRow['quantity'];
                }
                $orderData[$dbOrderRow['Order']['name']] = $detail;
            }
